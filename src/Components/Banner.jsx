    ...
    <div className="py-6 ">
      ...
      <div className="bg-linear-to-r from-[#632EE3] to-[#9F62F2] p-5 text-white text-center w-screen -mx-[calc((100vw-100%)/2)]  ">
        ...
        <div className="flex justify-center py-5 gap-12">
          <div>
            <p>Total Downloads</p>
            <h2 className="text-2xl md:text-4xl font-bold">29.6M</h2>
            <p>21% more than last month</p>
          </div>
          <div>
            <p>Total Reviews</p>
            <h2 className="text-2xl md:text-4xl font-bold">906K</h2>
            <p>46% more than last month</p>
          </div>
          <div>
            <p>Active Apps</p>
            <h2 className="text-2xl md:text-4xl font-bold">132+</h2>
